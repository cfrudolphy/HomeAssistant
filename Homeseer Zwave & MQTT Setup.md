...
* Ref ID: 7 Name: Back Door Lock Battery - sensors.yaml  
    ...
    *  Publish:  
        ...
        *$$STATUS:*
* Ref ID: 9 Name: Back Door Access Control Notification
    * Publish:  
...
#### Parent
* Ref ID: 42 Name: Fan Control Living Room Living Room Fan
    * Subscribe:  
...
* 14287 Fan Control Switch
#### Parent
* Ref ID: 192 Name: Fan Control Master Bedroom Master Bedroom Fan
    * Subscribe:  
...
* Ref ID: 200 Name: Front Door Sensor Notification
    ...
    *$$STATUS:*   
* Ref ID: 201 Name: Front Door Sensor Tamper Switch
...
#### Children
* Ref ID: 1082 Name: Kitchen Light 3 Central Scene
    * Publish:  
...
#### Children
* Ref ID: 1085 Name: Kitchen Light 1 Central Scene
    * Publish:  
